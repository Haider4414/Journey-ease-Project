               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="{{URL::asset('uploads/profile/'.$details->picture )}}" alt="#" /></a>
                     </div>
                  </div>
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="{{URL::to('dashboard')}}">> <span>Home</span></a>
                           </li>
                     ...
                     <li><a href="{{URL::to('hotels')}}"><i class="fa fa-table purple_color2"></i> <span>Hotels</span></a></li>
                     <li><a href="{{URL::to('vehicals')}}"><i class="fa fa-table purple_color2"></i> <span>Vehicals</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="{{URL::to('profile')}}">> <span>Profile</span></a>
                           </li>
