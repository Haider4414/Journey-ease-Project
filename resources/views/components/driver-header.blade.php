               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="{{URL::asset('admin/images/layout_img/user_img.jpg')}}" alt="#" /></div>
                        <div class="user_info">
                           <h6>Haider</h6>
                           <p><span class="online_animation"></span> Driver</p>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="{{URL::to('driver')}}">> <span>Home</span></a>
                           </li>
                     ...
                     <li><a href="{{URL::to('driverBookings/Vehicle')}}"><i class="fa fa-table purple_color2"></i> <span>Bookings</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="{{URL::to('driverProfile')}}">> <span>Profile</span></a>
                           </li>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="{{URL::asset('admin/images/logo/logo.png')}}" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{URL::asset('admin/images/layout_img/user_img.jpg')}}" alt="#" /><span class="name_user">Haider</span></a>
