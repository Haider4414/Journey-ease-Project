               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="{{URL::asset('images/cars/car2.jpg')}}" alt="#" /></a>
                     </div>
                  </div>
                  <div class="sidebar_user_info">
                     <div class="icon_setting"></div>
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="{{URL::asset('images/cars/car2.jpg')}}" alt="#" /></div>
                        <div class="user_info">
                           <h6>Haider</h6>
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="{{URL::to('email')}}">> <span>Email</span></a></li>
